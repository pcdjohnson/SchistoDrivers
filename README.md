# SchistoDrivers
 ...
 The first power analysis estimates power across a range of model parameter assumptions and sample sizes, detailed in comments in the script PowerAnalysis.R. Results are output as CSV to the results directory and plotted to schisto_power1.png.
...
## Power analysis 2: Randomised control trial protocol for the effect of food prior to treatment on praziquantel absorption
 ...
 The second  power analysis estimates power across a range of model parameter assumptions and sample sizes, detailed in comments in the script PowerAnalysis.R.
