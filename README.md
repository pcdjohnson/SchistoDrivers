# SchistoDrivers
 ...
 The script PowerAnalysis.R estimates power across a range of model parameter assumptions and sample sizes, detailed in comments in the R script. Results are output as CSV to the results directory and plotted to schisto_power.pdf.
